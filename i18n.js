...
(function (root) {
  ...
  var STRINGS = {
    en: {
      ...
      tile_msg_title: "Messages",
      tile_msg_sub: "Write to the office",
      tile_msg_sub_staff: "Inbox and groups",
      msg_new_one: "1 new",
      msg_new_n: "{n} new",
      msg_new_many: "More than 9 new",
      edu_new: "New",
    ...
    es: {
      ...
      tile_msg_title: "Mensajes",
      tile_msg_sub: "Escriba a la oficina",
      tile_msg_sub_staff: "Bandeja de entrada y grupos",
      msg_new_one: "1 nuevo",
      msg_new_n: "{n} nuevos",
      msg_new_many: "Más de 9 nuevos",
      edu_new: "Nueva",
